          ...
          <template v-if="step === 'form'">
            <div class="mb-4.5 flex items-center gap-2.5 rounded-md border border-info-border bg-info-bg px-3.5 py-3.5">
              ...
              <p class="m-0 text-[12.5px] leading-[1.5] text-info-fg-deep">
                Minimum 500 FCFA · une seule demande en attente à la fois. Solde disponible : <strong>{{ formatFcfa(wallet.balanceTotal.value) }}</strong>.
              </p>
            </div>
          ...
          <template v-else>
            <div class="px-0.5 py-1 text-center">
              ...
              <p class="mx-auto mb-0 mt-2.5 max-w-[320px] text-sm leading-[1.6] text-[var(--text-muted)]">
                Votre retrait de {{ amountFmt }} est en attente. Vous serez notifié à l'approbation, puis au virement.
              </p>
